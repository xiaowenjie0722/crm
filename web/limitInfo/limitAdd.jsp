            ...
            <div class="row">
                <form class="form-horizontal" action="/limitServlet" method="post" onsubmit="return verify()">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-xs-6 ">
                            <input type="text" class="form-control input-sm duiqi"  name="limitname" required="true" missingMessage="必须填写"/>
                        </div>
                    </div>
                       <div class="form-group ">
                           <label  class="col-xs-3 control-label">状态码：</label>
                           <div class="col-xs-6 ">
                               <input type="text" class="form-control input-sm duiqi"  name="limitstatus" required="true" missingMessage="必须填写"/>
                           </div>
                       </div>
                    <div class="form-group">
                        <%--@declare id="rootmessage"--%><label for="rootMessage" class="col-xs-3 control-label">描述：</label>
                        <div class="col-xs-6 ">
                            <textarea class="form-control input-sm duiqi" name="info" id="describe"></textarea><br>
